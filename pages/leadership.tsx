...
function Leadership() {
    ...
    return (
        <section className=" flex flex-col  items-start container">
            ...
            <div className="grid grid-cols-4 gap-4 p-5 w-full border">
                <div className="shadow-[0px_8px_40px_rgba(9,_44,_76,_0.16)] h-[25rem] w-[16rem] rounded-md overflow-hidden">
                    <div className="">
                        <Image
                            className=""
