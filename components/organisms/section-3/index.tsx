...
function SectionThree() {
    return (
        <section
            id="sectionThree"
            className="sect  min-h-[60rem]  w-screen overflow-hidden pb-6 xl:h-screen relative font-theme flex justify-evenly  px-4 "
        >
            ...
            <div className=" w-full h-[60rem] mb-[8rem] flex flex-col md:flex-row">
